...
export function PersonalizedBriefingPanel() {
  ...
  return (
    <section className="rounded-card border border-brand-500/30 bg-brand-500/[0.04] p-5">
      ...
      {briefing && (
        <pre className="mt-3 whitespace-pre-wrap rounded-md border border-white/10 bg-black/30 p-3 text-sm leading-relaxed text-white/85">
          {briefing}
        </pre>
      )}
    </section>
