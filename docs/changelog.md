...
- **XAY briefing gateway.** Scheduled and on-demand briefings now prefer XAY's OpenAI-compatible gateway with `llama-3.3-70b-versatile`, then fall back to direct Groq and Gemini. Analyst chat remains Gemini-first.
