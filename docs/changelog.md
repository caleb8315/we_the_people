...
- Personalized briefings now fall back to compact source summaries when every AI provider is unavailable, omitting feeds that contain full article bodies and recording sanitized provider diagnostics in server logs.
